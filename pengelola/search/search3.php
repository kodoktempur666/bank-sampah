...
<?php include 'assets/components/headerpeng.php'; ?>
    <div class="container mt-5">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <h5 class="card-title"><?= htmlspecialchars($user['nama_warung']) ?></h5>
                ...
                <div class="btn-group" role="group" aria-label="Aksi">
                    <a href="page.php?mod=edit-war&id=<?= $user['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                    
                    <!-- Tombol Hapus dengan Modal -->
                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal" data-id="<?= $user['id'] ?>">Hapus</button>

                    <!-- Tombol Verifikasi dengan Modal, hanya tampil jika user belum diverifikasi -->
                    <?php if ($user['is_verified'] == 0): ?>
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#verifyModal" data-id="<?= $user['id'] ?>">Verifikasi</button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
